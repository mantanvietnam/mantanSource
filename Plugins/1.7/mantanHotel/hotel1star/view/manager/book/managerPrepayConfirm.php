...
<section role="main" class="content-body">
    ...
    <div class="row">
        <div class="col-md-12">
            <form id="summary-form" method="post" action="<?php echo $urlHomes . 'managerPrepayProcess'; ?>" class="form-horizontal">
                <section class="panel">
                    <header class="panel-heading">
                        ...
                        <h2 class="panel-title">Trả trước: <?php echo $dataRoom['Room']['name']; ?></h2>
                    </header>
