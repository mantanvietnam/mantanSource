...
<section role="main" class="content-body">
    <header class="page-header">
        ...
        <div class="right-wrapper pull-right">
            <ol class="breadcrumbs">
                ...
                <li><span>Danh sách cơ sở lưu trú</span></li>
            </ol>
    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <h2 class="panel-title">Danh sách cơ sở lưu trú</h2>
        </header>
        <div class="panel-body">           
            <div class="row" style="margin-bottom: 1em;">
                <form class="form-inline" role="form" method="get" action="">
                    <div class="form-group col-sm-6 text-left">
                        <a href="<?php echo $urlHomes; ?>managerAddHotel" class="btn btn-primary btn-sm">Thêm cơ sở lưu trú</a>
                    </div>
                ...
                <table class="table table-bordered table-striped mb-none" id="">
                    ...
                    <tbody>
                        ...
                        ';
                            ...
                            echo '<tr>
                                    <td align="center" colspan="7">Không có cơ sở lưu trú nào.</td>
                                </tr>';
                        }
                        ?>
