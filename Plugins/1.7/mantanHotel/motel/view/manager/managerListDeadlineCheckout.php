...
<section role="main" class="content-body">
    <header class="page-header">
        <h2>Danh sách khách đến hạn trả phòng</h2>
    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <h2 class="panel-title">Danh sách khách đến hạn trả phòng</h2>
        </header>
                        ...
                        if (!empty($listData)) {
                            ...
                            foreach ($listData as $key => $tin) {
                                ...
                                <tr> 
                                    ...
                                    <td><?php echo @date('d/m/Y',$tin['Room']['checkin']['dateCheckoutForesee']); ?></td>
                                </tr> 
                                <?php
                            }
                        } else {
                            ?>
                            <tr>
                                <td align="center" colspan="6">Chưa có khách hàng nào đến hạn cần trả phòng.</td>
                            </tr>
                        <?php }
                        ?>   
                    </tbody>
