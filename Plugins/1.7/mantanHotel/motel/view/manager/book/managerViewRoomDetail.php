                    ...
                    <div class="panel-body">
                        <div class="row">    
                            <div class="col-sm-7">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                    <input type="text" name="birthday" id="birthday" data-plugin-datepicker class="form-control" value="<?php echo @$dataRoom['Room']['checkin']['Custom']['birthday'];?>" />
                                    </div>
                                </div>
                                <div class="form-group">
                                		...
                                		<select id="company" name="nationality" class="form-control">
                                            <?php
                                                ...
                                                foreach($listCountry as $country){
                                                    if(empty($dataRoom['Room']['checkin']['Custom']['nationality']) || $country['id']!=$dataRoom['Room']['checkin']['Custom']['nationality']){
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="user" class="form-control" value="<?php echo @$dataRoom['Room']['checkin']['Custom']['user'];?>"  />
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-7">
                                ...
                                <div class="form-group">
                                    <label class="col-md-4"><strong>Chu kỳ thanh toán:</strong></label>
                                    <div class="col-md-8">
                                        <?php global $paymentCycle; echo @$paymentCycle[$dataRoom['Room']['checkin']['paymentCycle']['number']]; ?>
                                    </div>
                                </div>  
                                <div class="form-group">
                                    <label class="col-md-4"><strong>Hạn thanh toán:</strong></label>
                                    <div class="col-md-8">
                                        <?php echo @date('d/m/Y',$dataRoom['Room']['checkin']['paymentCycle']['time']); ?>
                                    </div>
                                </div>                       
                            </div>
                            <div class="col-sm-5">
