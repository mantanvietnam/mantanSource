...
{
    return array(   'editCollectionBill'=>'Sửa thông tin phiếu thu',
...
function getMenuSidebarLeftManager() {
    global $urlHomes;
    return array(
        array('icon' => 'fa-bed', 'name' => 'Quản lý nhà nghỉ', 'link' => '',
            'sub' => array(array('icon' => '', 'name' => 'Sơ đồ nhà nghỉ', 'link' => $urlHomes . 'managerHotelDiagram', 'permission' => 'managerHotelDiagram'),
