    ...
    <header class="page-header">
        ...
        <div class="right-wrapper pull-right">
            <ol class="breadcrumbs">
                ...
                <li><span>Thêm số lượng Hàng hóa</span></li>
            </ol>
        ...
        <div class="col-md-12">
            ...
            <section class="panel">
                <header class="panel-heading">
                    ...
                    <h2 class="panel-title">Thêm số lượng Hàng hóa</h2>
                </header>
                <div class="panel-body">
                    <form id="" action="" class="form-horizontal" method="post">
                        <div class="form-inline">
                            <label class="control-label">Số mặt hàng cần nhập kho</label>
                            ...
                            <table class="table table-bordered table-striped mb-none">
                                ...
                                <tbody>
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td><input type="number" required="" name="soluong[<?php echo $i;?>]" min="1" class="form-control"  placeholder="Số lượng (cái, chiếc, chai, lọ)"/></td>
                                    </tr>
                                    <?php }?>
                                </tbody>
                            </table>
