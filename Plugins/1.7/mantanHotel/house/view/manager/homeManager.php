                                        ...
                                        <div class="panel-body">
                                            <div class="widget-summary">
                                                ...
                                                <div class="widget-summary-col">
                                                    <div class="summary">
                                                        <h4 class="title">Khách yêu cầu dịch vụ</h4>
                                                        <div class="info">
                                                            <strong class="amount"><?php echo number_format($countNotification);?></strong>
                                                        </div>
                                                    </div>
                                                    <div class="summary-footer">
                                                        <a href="<?php echo $urlHomes.'managerListNotification';?>" class="text-muted text-uppercase">(Chi tiết)</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <section class="panel panel-featured-left panel-featured-quartenary">
                                        <div class="panel-body">
                                            <div class="widget-summary">
                                                ...
                                                <div class="widget-summary-col">
                                                    <div class="summary">
                                                        <h4 class="title">Sinh nhật</h4>
                                                        <div class="info">
                                                            <strong class="amount"><?php echo number_format($countBirthday);?></strong>
                                                        </div>
                                                    </div>
                                                    <div class="summary-footer">
                                                        <a class="text-muted text-uppercase">
                                                            <a href="<?php echo $urlHomes.'managerListBirthday';?>" class="text-muted text-uppercase">(Chi tiết)</a>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <section class="panel panel-featured-left panel-featured-quartenary">
                                        <div class="panel-body">
                                            <div class="widget-summary">
                                                ...
                                                <div class="widget-summary-col">
                                                    <div class="summary">
                                                        <h4 class="title">Phòng sắp đến ngày thu tiền</h4>
                                                        <div class="info">
                                                            <strong class="amount"><?php echo number_format($countDeadlinePay);?></strong>
                                                        </div>
                                                    </div>
                                                    <div class="summary-footer">
                                                        <a class="text-muted text-uppercase">
                                                            <a href="<?php echo $urlHomes.'managerListDeadlinePay';?>" class="text-muted text-uppercase">(Chi tiết)</a>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
