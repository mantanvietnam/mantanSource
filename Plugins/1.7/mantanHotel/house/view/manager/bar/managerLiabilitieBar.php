...
<section role="main" class="content-body">
    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <h2 class="panel-title">Công nợ phải thu quầy bar</h2>
                        ...
                        if (!empty($listData)) {
                            foreach ($listData as $data) {
                                ...
                                echo '<tr class="gradeX">
                                        <td>' . $data['LogBar']['dataTable']['BarTable']['checkin']['cus_name'] . '</td>
                                        <td>' . $dateCheckin['mday'] . '/' . $dateCheckin['mon'] . '/' . $dateCheckin['year'] . ' - ' . $dateCheckout['mday'] . '/' . $dateCheckout['mon'] . '/' . $dateCheckout['year'] . '</td>
                                        <td>' . $data['LogBar']['dataTable']['BarTable']['name'] . '</td>
                                        <td>' . number_format($data['LogBar']['pricePay']) . ' VNĐ</td>
                                        <td class="actions">
                                            <a href="/managerEditLiabilitieBar?id=' . $data['LogBar']['id'] . '" class="on-default edit-row" data-toggle="tooltip" data-trigger="hover" data-original-title="Sửa công nợ" id="inputTooltip"><i class="fa fa-pencil"></i></a>
                                        </td>
                                    </tr>';
