...
<section role="main" class="content-body">
    <header class="page-header">
        <h2>Danh sách khách gửi yêu cầu</h2>
        ...
        <div class="right-wrapper pull-right">
            <ol class="breadcrumbs">
                ...
                <li><span>Danh sách khách gửi yêu cầu</span></li>
            </ol>
    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <h2 class="panel-title">Danh sách khách gửi yêu cầu</h2>
        </header>
                            ...
                            foreach ($listData as $data) {
                                ...
                                echo '
                                    <tr class="gradeX">
                                        ...
                                        <td>' . nl2br($data['Notification']['content']) . '</td>
