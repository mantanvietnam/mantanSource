...
function homeManager() {
    ...
    if (checkLoginManager()) {
        ...
        $countBirthday= count($modelRoom->getRoomBirthdayUser($_SESSION['idHotel']));
        $countReport= $modelReport->getCountReport('new',$_SESSION['idHotel']);
        $countDeadlinePay= count($modelRoom->getRoomDeadlinePay($_SESSION['idHotel']));
        $countDeadlineCheckout= count($modelRoom->getRoomDeadlineCheckout($_SESSION['idHotel']));
        $countNotification= $modelNotification->getCountNotification($_SESSION['idHotel']);

        setVariable('countBirthday', $countBirthday);
        setVariable('countNotification', $countNotification);
        setVariable('countDeadlinePay', $countDeadlinePay);
