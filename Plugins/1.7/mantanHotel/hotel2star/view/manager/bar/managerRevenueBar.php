                    ...
                    <tbody>
                        ...
                        if (!empty($listData)) {
                            ...
                            foreach ($listData as $key => $data) {
                                $dateCheckin = getdate($data['LogBar']['dataTable']['BarTable']['checkin']['dateCheckin']);
                                $dateCheckout = $data['LogBar']['today'];
                                $idStaffCheckin = $data['LogBar']['dataTable']['BarTable']['checkin']['idStaff'];
                                $idStaffCheckout = $data['LogBar']['dataTable']['BarTable']['checkin']['idStaffCheckout'];

                                if ($idStaffCheckin == $data['LogBar']['dataTable']['BarTable']['checkin']['idManager']) {
                                ...
                                if ($idStaffCheckout == $data['LogBar']['dataTable']['BarTable']['checkin']['idManager']) {
                                ...
                                $nameRoom = $data['LogBar']['dataTable']['BarTable']['name'];
                                $totalMoney = $totalMoney + $data['LogBar']['pricePay'];
                                ?>
                                <tr class="gradeX">
                                    <td><?php echo $key + 1 ?></td>
                                    <td><?php echo $nameRoom; ?></td>
                                    <td><?php echo $data['LogBar']['dataTable']['BarTable']['checkin']['cus_name']; ?></td>
                                    ...
                                    <td><?php echo number_format($data['LogBar']['pricePay']) . ' VNĐ'; ?></td>
