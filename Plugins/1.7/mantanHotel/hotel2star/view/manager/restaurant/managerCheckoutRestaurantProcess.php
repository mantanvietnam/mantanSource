...
<html>
    <head>
        <title>Phiếu thanh toán nhà hàng</title>
        <meta charset="UTF-8"/>
    ...
    <body>
        <div class="container">
            ...
            <section>
                ...
                <div class="content">
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-6">Bàn: <?php echo $dataTable['Table']['name'];?></div>
        ...
        <script type="text/javascript">
            window.print();
            window.open('<?php echo $urlHomes . 'managerRestaurantDiagram';?>');
        </script>
    </body>
</html>