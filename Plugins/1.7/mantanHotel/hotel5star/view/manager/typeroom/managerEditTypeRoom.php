                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group form-inline">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="number" value="<?php echo $data['TypeRoom']['gia_thang']; ?>" name="gia_thang" class="form-control" min="0" style="width: 100%;"/>
                                                </div>
                                            </div> 
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group form-inline">
                                                <label class="col-sm-2 control-label" style="padding-top: 0;">Giá</label>
                                                <div class="col-sm-10">
                                                    <input type="number" value="<?php echo $data['TypeRoom']['gia_nam']; ?>" name="gia_nam" class="form-control" min="0" style="width: 100%;"/>
                                                </div>
                                            </div>   
                                        </div>
                                    </div>
                    ...
                    <footer class="panel-footer">
                        <div class="row">
                            <div class="text-center">
                                ...
                                <button type="button" onclick="window.location= '/managerListTypeRoom';" class="btn btn-default">Hủy</button>
                            </div>
                        </div>
                    </footer>
                </section>
