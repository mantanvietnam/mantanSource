                    ...
                    <div class="panel-body">
                        <form action="" method="post">
                            ...
                            if (isset($_GET['status']))
                                switch ($_GET['status']) {
                                    case 1: echo '<p>Yêu cầu cấp lại mật khẩu thành công! Bạn vui lòng kiểm tra Email để xem thông tin đăng nhập!</p>';
                                        break;
                                    case -1: echo '<p>Yêu cầu cấp lại mật khẩu không thành công!</p>';
                                        break;
                                    case -2: echo '<p>Tài khoản của bạn chưa được kích hoạt!</p>';
                                        break;
                                    case -4: echo '<p>Tên đăng nhập hoặc email của bạn không tồn tại!</p>';
                                        break;
                                }
                            ?>
							<div class="form-group mb-lg">
                                <label>Nhập tên đăng nhập hoặc Email của bạn:</label>
