...
<section role="main" class="content-body">
    ...
    <section class="panel">
        ...
        <div class="panel-body">           
            ...
            <form class="form-inline" role="form" action="/managerRevenue" method="get">
                    ...
                    <tbody>
                        ...
                        if (!empty($listData)) {
                            ...
                            foreach ($listData as $key => $data) {
                                ...
                                $idStaffCheckin = $data['Book']['dataRoom']['Room']['checkin']['idStaff'];
                                $idStaffCheckout = $data['Book']['dataRoom']['Room']['checkin']['idStaffCheckout'];

                                if ($idStaffCheckin == $data['Book']['dataRoom']['Room']['checkin']['idManager']) {
                                ...
                                if ($idStaffCheckout == $data['Book']['dataRoom']['Room']['checkin']['idManager']) {
                                ...
                                $nameRoom = $data['Book']['dataRoom']['Room']['name'];
