...
<section role="main" class="content-body">
    <header class="page-header">
        <h2>Thông tin chi tiết bàn bar</h2>
        ...
        <div class="right-wrapper pull-right">
            <ol class="breadcrumbs">
                ...
                <li><span>Thông tin chi tiết bàn bar</span></li>
            </ol>
                    ...
                    <footer class="panel-footer">
                        <div class="row">
                            <div class="text-center">
                                <a href="<?php echo $urlHomes.'managerBarDiagram'; ?>"><button class="btn btn-primary">Quay lại</button></a>
                            </div>
                        </div>
                    </footer>
                </section>
