...
<html lang="en">
    ...
    <body>
        <div class="container" id="payment_bill">
            ...
            <div class="row text-center">
                <h2 class="text-uppercase">Phiếu chi</h2>
            ...
            <div class="content">
                <div class="row text-left">
                    <p>
                        <span class="col-sm-3">Người nhận tiền:</span>
                        <span class="col-sm-9"><?php echo @$data['Bill']['nguoi_nhan'];?></span>
                    </p>
                </div>
                <div class="row text-left">
                    <p>
                ...
                <div class="row text-left">
                    <p>
                        <span class="col-sm-3">Lý do chi: </span>
                        <span class="col-sm-9"><?php echo @$data['Bill']['note'];?></span>
                    </p>
                </div>
                <div class="row text-left">
                    <p>
                        <span class="col-sm-3">Số tiền: </span>
                        <span class="col-sm-9"><?php echo number_format(@$data['Bill']['coin']);?>đ (<?php echo convert_number_to_words($data['Bill']['coin']);?>)</span>
                    </p>
                </div>
                <div class="row text-left">
                    <p>
