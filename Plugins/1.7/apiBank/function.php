<?php 
include 'lib/momo_api.php';

$menus= array();
$menus[0]['title']= 'API Bank';
$menus[0]['sub'][0]= array('name'=>'TPBank','url'=>$urlPlugins.'admin/apiBank-view-setting-tpbank.php','classIcon'=>'fa-search','permission'=>'settingTPBank');

addMenuAdminMantan($menus);

function get_token_tpbank($username,$password){
...
function get_history_tpbank($token,$stk_tpbank,$ngay_bat_dau_check,$ngay_ket_thuc_check){
