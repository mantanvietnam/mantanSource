...
<?php
	$breadcrumb= array( 'name'=>'Nhân sự',
						'url'=>$urlPlugins.'admin/manager-view-categoryManager.php',
						'sub'=>array('name'=>'Phòng ban')
					  );
...
?>    
	        ...
	        <table id="listTable" cellspacing="0" class="tableList">
	                ...
	                ?>
	                        <tr id="trList<?php echo $components['id'];?>">
	                          ...
	                          <td height="40" id="name<?php echo $components['id'];?>"><a href="<?php echo $urlHomes.'manager/'.$components['slug'].'.html';?>"><?php echo $components['name'];?></a></td>
	  ...
	  <div id="themData">
	      <form method="post" action="<?php echo $urlPlugins;?>admin/manager-saveCategoryManager.php">
...
<script type="text/javascript">
	var urlWeb="<?php echo $urlPlugins.'admin/manager-saveCategoryManager.php';?>";
