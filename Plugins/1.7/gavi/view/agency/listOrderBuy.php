    ...
    <div class="container">
        <div class="collapse-item">
            <div class="nav-menu-item">
                <div class="nav-menu-item-a <?php if(!isset($_GET['idStatus'])) echo 'current-tab';?>"><a href="/listOrderBuy">Tất cả</a></div>
                <div class="nav-menu-item-a <?php if(isset($_GET['idStatus']) && $_GET['idStatus']==1) echo 'current-tab';?>"><a href="/listOrderBuy?idStatus=1">Chờ duyệt</a></div>
                <div class="nav-menu-item-a <?php if(isset($_GET['idStatus']) && $_GET['idStatus']==3) echo 'current-tab';?>"><a href="/listOrderBuy?idStatus=3">Hủy bỏ</a></div>
                <div class="nav-menu-item-a <?php if(isset($_GET['idStatus']) && $_GET['idStatus']==2) echo 'current-tab';?>"><a href="/listOrderBuy?idStatus=2">Đã hoàn thành</a></div>
            </div>
        </div>
    </div>
</nav>
...
<div class="container g_search">
    <form action="" method="get" accept-charset="utf-8">
        <input type="hidden" name="idStatus" value="<?php echo @$_GET['idStatus'];?>">
...
<div class="container g_search page-content">
    <a href="/addOrder" class="col-xs-12 col-sm-12 item">
            ...
            if(!empty($listData)){
                foreach($listData as $data){
                    ...
                    if($data['Order']['status']==1){
                        echo '<a href="/cancelOrderAgency?id='.$data['Order']['id'].'" onclick="return confirm(\'Bạn có chắc chắn muốn hủy đơn hàng này không ?\');"><i class="fa fa-trash" aria-hidden="true"></i> Xóa</a>';
                    }
