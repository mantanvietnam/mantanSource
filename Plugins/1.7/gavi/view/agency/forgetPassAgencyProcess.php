...
<body>
    ...
    <form action="" method="post">
        <div class="form-group">
           <label for="">Số điện thoại đại lý</label>
           <input type="text" required="" class="form-control" id="" placeholder="Nhập số điện thoại đại lý" name="phone" value="<?php echo @$_GET['phone'];?>">
           <label for="">Mã lấy lại mật khẩu</label>
           <input type="text" class="form-control" id="" placeholder="Nhập mã lấy lại mật khẩu" name="codeForgetPass" value="" required="">
           <label for="">Mật khẩu mới</label>
           <input type="password" class="form-control" id="" placeholder="" name="pass" value="" autocomplete="off" required="">
       </div>

      <button type="submit" class="btn btn-gavi btn-auth-submit">Lấy lại mật khẩu</button>
  </form>
