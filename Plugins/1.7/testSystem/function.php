<?php
$menus = array();
$menus[0]['title'] = 'Quản lý đề thi';
$menus[0]['sub'][0] = array('name' => 'Xem điểm học sinh', 'url' => $urlPlugins . 'admin/testSystem-admin-viewPoint.php','permission'=>'viewPoint');
$menus[0]['sub'][1] = array('name' => 'Loại đề thi', 'url' => $urlPlugins . 'admin/testSystem-admin-listTypeTest.php','permission'=>'listTypeTest');
$menus[0]['sub'][2] = array('name' => 'Danh sách đề thi', 'url' => $urlPlugins . 'admin/testSystem-admin-listTest.php','permission'=>'listTest');
$menus[0]['sub'][3] = array('name' => 'Tài khoản học sinh', 'url' => $urlPlugins . 'admin/testSystem-admin-listStudent.php','permission'=>'listStudent');
