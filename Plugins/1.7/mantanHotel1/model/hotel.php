...
class Hotel extends AppModel {
    ...
    function saveHotel($name, $manager,$idStaff, $city, $district, $address, $phone, $email, $website, $typeHotel, $furniture, $local, $images, $id, $price,$info,$coordinates,$coordinates_x,$coordinates_y, $yahoo, $skype,$linkCamera) {
        $today = getdate();
...
//                'manager' => $idManager,
    ...
    function getAround($latGPS,$longGPS,$radius,$fields=null)
    {
