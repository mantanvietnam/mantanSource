...
<section role="main" class="content-body">
    <header class="page-header">
        ...
        <div class="right-wrapper pull-right">
            <ol class="breadcrumbs">
                ...
                <li> <a href="<?php echo $urlNow; ?>"><span>Danh sách đặt phòng đã xử lý</span></a></li>
            </ol>
    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <h2 class="panel-title">Danh sách đặt phòng đã xử lý</h2>
            ...
            if (isset($_GET['status'])) {
                switch ($_GET['status']) {
                    ...
                    case 4: echo '<p style="color:red;">Xóa đặt phòng thành công!</p>';
                        break;
                    case 'checkinError': echo '<p style="color:red;">Lỗi checkin do '.$_GET['name'].' đang có khách ở</p>'; 
                        break;
                }
            }
            ?>
        ...
        <div class="panel-body">           
                            ...
                            foreach ($listData as $key => $order) {
                                ...
                                <tr> 
                                    ...
                                    <td class="" align="center">
                                        <a class="btn btn-default"  href="<?php echo $urlHomes . 'managerProcessOrder?id=' . $order['Order']['id']; ?>">Sửa</a>
                                        &nbsp;
                                        ...
                                        &nbsp;
                                        <a class="btn btn-default"  href="<?php echo $urlHomes . 'managerProcessOrderCheckin?id=' . $order['Order']['id']; ?>">Checkin</a>
            ...
            <div class="row panel-body" style="margin-top: 1em;">
                ...
                if($totalPage>0){
                    ...
                    $urlNow = $urlHomes.'managerListOrderProcess';
