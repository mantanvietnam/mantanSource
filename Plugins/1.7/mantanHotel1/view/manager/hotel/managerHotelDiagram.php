...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $.contextMenu({
            ...
            items: {
                "paid": {name: "Trả phòng", icon: "checkout", accesskey: "c o"},
                ...
                "view": {name: "Xem thông tin phòng", icon: "view", accesskey: "u s"},
                "sep1": "---------",
        ...
        $.contextMenu({
            ...
            items: {
                ...
                "listwaiting": {name: "Danh sách khách chờ", icon: "list", accesskey: "l w"},
                "edit": {name: "Sửa cài đặt phòng", icon: "edit", accesskey: "e"},
                "clear": {name: "Đã dọn phòng", icon: "edit", accesskey: "c"},
            ...
            foreach ($listFloor as $floor) {
                ...
                foreach ($listRooms[$floor['Floor']['id']] as $infoRoom) {
                    if (empty($infoRoom['Room']['checkin'])) {
                        ...
                        if (!isset($listTypeRoom[$infoRoom['Room']['typeRoom']]))
                            $listTypeRoom[$infoRoom['Room']['typeRoom']] = '';
                        $dateCheckin = date("d/m", $infoRoom['Room']['checkin']['dateCheckin']);
                        $today = time();
