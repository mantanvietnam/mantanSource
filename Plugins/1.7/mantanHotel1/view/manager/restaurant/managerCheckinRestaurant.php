    ...
    <header class="page-header">
        ...
        <div class="right-wrapper pull-right">
            <ol class="breadcrumbs">
                ...
                <li><span>Nhận bàn nhà hàng</span></li>
            </ol>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form id="summary-form" action="" method="post" class="form-horizontal">
				<input name="idtable" type="hidden" value="<?php echo $dataTable['Table']['id']; ?>" />
                <section class="panel">
                    <header class="panel-heading">
                        ...
                        <h2 class="panel-title">Nhận bàn nhà hàng: <?php echo $dataTable['Table']['name']; ?></h2>
                    </header>
                    ...
                    <footer class="panel-footer">
                        <div class="row">
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary">Nhận bàn nhà hàng</button>
