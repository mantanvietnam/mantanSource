...
<section role="main" class="content-body">
    ...
    <div class="row">
        <div class="col-md-12">
            <form id="summary-form" method="post" action="<?php echo $urlHomes . 'managerCheckoutBarProcess'; ?>" class="form-horizontal">
                <section class="panel">
                    ...
                    <footer class="panel-footer">
                        <div class="row">
                            <div class="text-center">
                                <button class="btn btn-primary">Trả bàn bar</button>
