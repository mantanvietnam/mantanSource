...
echo $urlHomeManager; ?>">
    ...
    <div class="row">
        <div class="col-md-12">
            <form id="summary-form" method="post" action="<?php echo $urlHomes . 'managerCheckoutBarConfirm'; ?>" class="form-horizontal">
                <input type="hidden" value="<?php echo $dataTable['BarTable']['id']; ?>" name="idroom" />
                <section class="panel">
                    <header class="panel-heading">
                        ...
                        <h2 class="panel-title">Bàn bar: <?php echo $dataTable['BarTable']['name']; ?></h2>
                    </header>
                    <div class="panel-body">
                        <div class="row">    
                            <div class="col-sm-6">
                                <h2 class="panel-title">Thông tin bàn bar</h2>
                                <br/>
                            ...
                            <div class="col-sm-6">
                                ...
                                if (!empty($dataTable['BarTable']['checkin']['hang_hoa'])) {
                                    foreach ($dataTable['BarTable']['checkin']['hang_hoa'] as $hang_hoa => $info) {
                                        if(!$_SESSION['infoManager']['Manager']['isStaff'] || in_array('editCheckoutBar',$_SESSION['infoManager']['Manager']['permissionAdvanced'])){
                    ...
                    <footer class="panel-footer">
                        <div class="row">
                            <div class="text-center">
                                ...
                                <a href="<?php echo $urlHomes . 'managerBarDiagram' ?>" class="btn btn-default">Hủy</a>
                            </div>
                        </div>
                    </footer>
                </section>
