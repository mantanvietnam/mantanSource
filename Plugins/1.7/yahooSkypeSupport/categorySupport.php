...
?>    
	    ...
	    <form action="" method="post" name="listForm">
	        ...
	        <table id="listTable" cellspacing="0" class="tableList">
	                ...
	                <tr>
	                  ...
	                  <td align="center" width="150">Nhóm hỗ trợ</td>
	  ...
	  <div id="themData">
	      <form method="post" action="">
		  	...
		  	Nhóm hỗ trợ<br /><br /><input type='text' required id='nameData' name="name" value='' />&nbsp;&nbsp;<input type='submit' value='Lưu' class='input' />
	      </form>
	  </div>
